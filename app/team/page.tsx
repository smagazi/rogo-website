    ...
    <section>
      ...
      <div className="team-members">
        ...
        <div className="team-member" style={{ marginBottom: '20px', display: 'flex', alignItems: 'center' }}>
          ...
          <div>
            <h3 className="text-2xl" style={{ color: 'white' }}> 
              <a href="https://www.linkedin.com/in/aaravkgoel/" target="_blank" rel="noopener noreferrer">
                Aarav Goel <span style={{ fontSize: '0.8em' }}>🔗</span>
              </a>
            </h3>
        ...
        <div className="team-member" style={{ marginBottom: '20px', display: 'flex', alignItems: 'center' }}>
          ...
          <div>
            <h3 className="text-2xl" style={{ color: 'white' }}>            
              <a href="https://www.linkedin.com/in/rohil-khare/" target="_blank" rel="noopener noreferrer">
                Rohil Kare <span style={{ fontSize: '0.8em' }}>🔗</span>
              </a>
            </h3>
        ...
        <div className="team-member" style={{ marginBottom: '20px', display: 'flex', alignItems: 'center' }}>
          ...
          <div>
            <h3 className="text-2xl" style={{ color: 'white' }}>            
              <a href="https://www.linkedin.com/in/nihalboina/" target="_blank" rel="noopener noreferrer">
                Nihal Boina <span style={{ fontSize: '0.8em' }}>🔗</span>
              </a>
            </h3>
        ...
        <div className="team-member" style={{ marginBottom: '20px', display: 'flex', alignItems: 'center' }}>
          ...
          <div>
            <h3 className="text-2xl" style={{ color: 'white' }}>            
              <a href="https://www.linkedin.com/in/parthbehani/" target="_blank" rel="noopener noreferrer">
                Parth Behani <span style={{ fontSize: '0.8em' }}>🔗</span>
              </a>
            </h3>
          ...
          <div>
            <h3 className="text-2xl" style={{ color: 'white' }}>            
              <a href="https://www.linkedin.com/in/sara-magaziotis-ginori/" target="_blank" rel="noopener noreferrer">
                Sara Magaziotis-Ginori <span style={{ fontSize: '0.8em' }}>🔗</span>
              </a>
            </h3>
        ...
        <div className="team-member" style={{ marginBottom: '20px', display: 'flex', alignItems: 'center' }}>
          ...
          <div>
            <h3 className="text-2xl" style={{ color: 'white' }}>            
              <a href="https://www.linkedin.com/in/skylerchan03/" target="_blank" rel="noopener noreferrer">
                Skyler Chan <span style={{ fontSize: '0.8em' }}>🔗</span>
              </a>
            </h3>
